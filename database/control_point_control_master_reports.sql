...
--
-- Table structure for table `control_master_reports`
--

DROP TABLE IF EXISTS `control_master_reports`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `control_master_reports` (
...
--
-- Dumping data for table `control_master_reports`
--
